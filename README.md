...
[Join the Outer Wilds Modding Discord](https://discord.gg/9vE5aHxcF9), we have a nice `#modding-support` channel for any mod help, and a `#modding` channel to discuss modding!
