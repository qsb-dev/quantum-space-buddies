...
internal class SpectateManager : MonoBehaviour, IAddComponentOnStart
{
	...
	private readonly ScreenPrompt _changeSpectateTargetPrompt = new(
		InputLibrary.toolOptionLeft,
		InputLibrary.toolOptionRight,
		"Switch Spectate Target" + "   <CMD1> <CMD2>",
	...
	public void Start()
	{
		...
		Locator.GetPromptManager().AddScreenPrompt(_changeSpectateTargetPrompt, PromptPosition.BottomCenter, false);
	}
	...
	public void ExitSpectate()
	{
		...
		_changeSpectateTargetPrompt.SetVisibility(false);
	}
