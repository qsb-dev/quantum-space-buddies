...
{
	public abstract class UnparentedBaseRigidBodySync : QNetworkTransform
	{
		...
		protected abstract OWRigidbody InitLocalTransform();
		protected abstract OWRigidbody InitRemoteTransform();
