...
{
	public abstract class BaseSectoredSync2 : SyncBase2
	{
		...
		public override void Start()
		{
			...
			// todo QSBSectorManager.Instance.SectoredSyncs.Add(this);
			base.Start();
		}
		...
		{
			base.OnDestroy();
			// todo QSBSectorManager.Instance.SectoredSyncs.Remove(this);
			if (SectorSync != null)
			{
				Destroy(SectorSync);
			}
