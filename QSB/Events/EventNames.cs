namespace QSB.Events
{
	public static class EventNames
	{
		...
		public const string RestartTimeLoop = nameof(RestartTimeLoop);
		public const string WakeUp = nameof(WakeUp);
		public const string DialogueCondition = nameof(DialogueCondition);
		public const string EnterQuantumMoon = nameof(EnterQuantumMoon);
		public const string ExitQuantumMoon = nameof(ExitQuantumMoon);
		...
		public const string QSBAnglerResync = nameof(QSBAnglerResync);
	}
}
